...
import { MapPin, Rocket, Trophy, ArrowRight, Target, HeartHandshake } from "lucide-react";
...
import teamAbdoulaye from "@/assets/images/team-abdoulaye.png";
import teamRahima from "@/assets/images/team-rahima.png";
import teamRasmata from "@/assets/images/team-rasmata.png";
import teamYasser from "@/assets/images/team-yasser.png";

const TEAM_IMAGES: Record<string, typeof teamAbdoulaye> = {
  abdoulaye: teamAbdoulaye,
  rahima: teamRahima,
  rasmata: teamRasmata,
  yasser: teamYasser,
};
    ...
    <main className="bg-white">
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-[1560px] mx-auto px-6 md:px-10 xl:px-16">
          ...
          {/* Équipe — visages et rôles de chacun */}
          <Reveal animation="fade-up">
            <div className="text-center max-w-xl mx-auto mb-14">
              ...
              <h2 className="text-[clamp(1.6rem,3.2vw,2.2rem)] font-display font-extrabold text-navy leading-tight mb-4">
                Quatre personnes, quatre rôles, une même mission
              </h2>
              <p className="text-[14.5px] text-gray-500 font-light leading-relaxed">
                FasoLab Virtuel est porté par une petite équipe fondatrice, chacun responsable
                d&apos;un pilier essentiel du projet.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-28">
            {TEAM.map((member, i) => (
              <Reveal key={member.name} animation="fade-up" delay={i * 90}>
                <div className="rounded-2xl border border-gray-100 overflow-hidden h-full card-hover flex flex-col">
                  <div className="relative aspect-[4/5] w-full overflow-hidden bg-navy">
                    <Image
                      src={TEAM_IMAGES[member.img]}
                      alt={member.name}
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <p className="text-[15.5px] font-bold text-navy leading-tight">{member.name}</p>
                    <p className="text-[11.5px] font-bold uppercase tracking-[0.1em] text-primary mt-1.5 mb-3">
                      {member.role}
                    </p>
                    <p className="text-[13.5px] text-gray-500 font-light leading-relaxed">
                      {member.bio}
                    </p>
                  </div>
                </div>
          ...
          <div className="grid sm:grid-cols-2 gap-5 mb-28">
            ...
            <Reveal animation="fade-up" delay={90}>
              <div className="rounded-2xl border border-gray-100 p-7 text-center h-full card-hover">
                ...
                <p className="text-[14.5px] font-bold text-navy">{SITE.founded}</p>
