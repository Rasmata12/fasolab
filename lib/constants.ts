export const SITE = {
  ...
  email: "fasolabvirtuel@gmail.com",
  phone: "+226 44 58 02 20",
  location: "Ouagadougou, Burkina Faso",
  founded: "Née en 2025",
};

// Réseaux sociaux officiels FasoLab. Chaque entrée est rendue dans le Footer
// et sur la page Contact — ajoutez simplement un objet ici pour en afficher
// un nouveau partout à la fois.
export const SOCIAL_LINKS = [
  {
    label: "Facebook",
    icon: "Facebook",
    href: "https://web.facebook.com/profile.php?id=61591866479476",
  },
  {
    label: "WhatsApp",
    icon: "WhatsApp",
    href: "https://chat.whatsapp.com/CxtvpDAHSHq0JSN5XgoSbQ",
  },
  {
    label: "TikTok",
    icon: "TikTok",
    href: "https://www.tiktok.com/@fasolab?_r=1&_t=ZS-992QKMBxWQn",
  },
];
...
export const TEAM = [
  {
    name: "YANKININ Abdoulaye Aliou",
    role: "Fondateur & Directeur Technique",
    bio: "Pilote la vision produit et l'architecture technique de FasoLab : plateforme 3D, intégration du bracelet capteur et intelligence artificielle de guidage.",
    img: "abdoulaye",
  },
  {
    name: "KAFANDO Kiswendsida Rahima",
    role: "Responsable Communication & Diffusion",
    bio: "Porte la voix de FasoLab auprès des écoles et du grand public : stratégie de communication et présence sur les réseaux sociaux.",
    img: "rahima",
  },
  {
    name: "KABRE Rasmata",
    role: "Responsable Finance",
    bio: "Structure le modèle économique du projet et pilote la gestion financière et le suivi budgétaire au quotidien. Contribue également au développement de la plateforme.",
    img: "rasmata",
  },
  {
    name: "BANAON Yasser Pouboulè",
    role: "Responsable Relations & Partenariats",
    bio: "Développe et entretient les relations avec les écoles, les institutions et les partenaires du projet, et coordonne tout ce qui touche à la représentation de FasoLab. Contribue également au développement de la plateforme.",
    img: "yasser",
  },
];
...
// NOTE : la Navbar définit désormais elle-même ses deux groupes de liens
// (LEFT_LINKS / RIGHT_LINKS dans components/Navbar.tsx) pour pouvoir les
// répartir de part et d'autre du CTA central. NAV_LINKS est conservé ici
// comme référence de la liste complète des pages publiques.
